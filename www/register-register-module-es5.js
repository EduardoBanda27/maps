...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(authSvc, navc) {
    ...
    RegisterPage.prototype.onRegister = function () {
        var _this = this;
        this.authSvc.signup(this.user.email, this.user.password, this.user.nombre).then(function (res) {
            _this.navc.navigateForward('tabs');
        });
    };
    ...
    RegisterPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"]])
    ], RegisterPage);
    return RegisterPage;
}());
