...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signup = function (email, password, nombre) {
        return firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(email, password).then(function () {
